...
I'm a frontend developer from **India** 🇮🇳, focused on building fast, responsive, and animated UIs.  

- 🧠 Currently sharpening my skills through freelance projects  
- ⚛️ Working with **React.js**, **Tailwind CSS**, **GSAP**  
- 🎨 Into UI/UX design, micro-interactions, and clean code  
- 🌐 Exploring APIs, Figma-to-code workflows & performance  

> ✨ Fun fact: I write code that *feels like design* and designs that *code themselves* 😄
